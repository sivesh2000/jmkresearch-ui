...
import { setTenders, setLoading, setError, setFilterPlayers } from "@/app/redux/slices/tenderSlice/ActiveTenderSlice"
import { Dispatch } from "@reduxjs/toolkit"
import { parseQueryParams } from "@/app/utils/functions"

export const getAllActiveTenders = (dispatch: Dispatch, filters: any) => async () => {
    try {
...
export const editTender = (dispatch: Dispatch) => async (id: number, formData: { name: string; isActive: boolean }) => {
    try {
...
export const addTender = (dispatch: Dispatch) => async (formData: { name: string; isActive: boolean }) => {
    try {
